...
const defs: Record<TarotSpreadType, PositionMeaning[]> = {
  ...
  'ancestral-ladder': ['Kether-Origin', 'Chokmah-Impulse', 'Binah-Structure', 'Chesed-Blessing', 'Geburah-Resilience', 'Tiphareth-Heartline', 'Netzach-Desire', 'Hod-Story', 'Yesod-Memory', 'Malkuth-Embodiment'].map((p) => ({ position: p, meaning: `Lineage station ${p}.`, hermeticFrame: 'Ancestral Ladder mapped to the Tree of Life.' }))
};
