...
import type { TiekatHabitatProfile } from '@/lib/tiekat/habitatProfile';
import type { TiekatHabitatDeckStoreEntry } from '@/lib/tiekat/habitatDeck';
...
type StoreMap = {
  ...
  habitatProfiles: TiekatHabitatProfile[];
  habitatDecks: TiekatHabitatDeckStoreEntry[];
