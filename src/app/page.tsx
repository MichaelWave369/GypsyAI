  ...
  return (
    <main className="space-y-5">
      <section className="panel space-y-3">
        <h2 className="text-2xl text-gold">Tarot + Astrology + Gene Keys</h2>
        <p>Grounded reflective readings with strict fact packets and local-first storage.</p>
        <div className="flex gap-3">
          <Link data-testid="home-cta-tarot" aria-label="Open Tarot" className="text-gold" href="/tarot">
            Tarot
          </Link>
          <Link data-testid="home-cta-astrology" aria-label="Open Astrology" className="text-gold" href="/astrology">
            Astrology
          </Link>
          <Link className="text-gold" href="/genekeys">
            Gene Keys
          </Link>
        </div>
      </section>
